...
Vous avez le choix entre deux algorithmes de tri:
- [**tri fusion**](/Lessons/Algorithmic/Sorting/#tri-fusion-merge-sort)
- [**tri rapide**](/Lessons/Algorithmic/Sorting/#tri-rapide-quick-sort)
...
Le [**counting sort**](/Lessons/Algorithmic/Sorting/#tri-par-dénombrement-counting-sort) est un algorithme de tri qui permet de trier un tableau d'entiers en temps linéaire (c'est à dire en $O(n)$).

...
Le mot clé `this` est un **pointeur** qui pointe vers l'**objet courant**. Il est utilisé principalement pour accéder aux membres de la structure/classe à partir d'une méthode (pour éviter les ambiguïtés avec les paramètres par [exemple](/Lessons/Fundamentals/Struct/#conflit-de-noms)).
...
Je t'invite à relire cette section également : [structure et this](/Lessons/Fundamentals/MemoryAllocation/#structure-et-this).

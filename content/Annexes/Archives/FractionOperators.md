...
- Réécrire les opérateurs `+`, `-`, `*` et `/` en utilisant les opérateurs affectation afin d'éviter de dupliquer le code ([deux-en-un](/Lessons/Algorithmic/Operators/#deux-en-un)) (Commenter l'ancienne version des opérateurs par exemple)

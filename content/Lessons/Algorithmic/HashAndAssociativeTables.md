...
Je vous invite à relire le cours précédent sur les [itérateurs](/Lessons/Algorithmic/AutoAndAlgorithm/#find) pour comprendre comment utiliser ces méthodes.
...
Les [énumérations](/Lessons/Fundamentals/Variables/#enum-un-type-supplémentaire) sont des types de données qui permettent de définir un ensemble de valeurs possibles pour une variable.
